...
export class imagery {
    ...
    async search_pictures(input) {
        ...
        const pictures = await server.exec("database", ["mutall_imagery2", false], "get_sql_data", [SqlSearch]);
        //
        ...
        const results1 = await server.exec("database", ["mutall_imagery2", false], "get_sql_data", [sqlresults]);
        //
